...
var Inventory = (function() {
    ...
    function init() {
        allItems = [
            ...
            // --- 10 New Shop Items ---
            new Item("Píldora del Artista", "Una cápsula dorada con la proporción 7:3 grabada.", 40,
                "* Tragas la Píldora del Artista.\n* Tu visión se agudiza. ATK +25% por 3 turnos.",
                function() { Player.addBuffAtk(0.25, 3); }),
            new Item("Té de Bondad Suprema", "Infusión esmeralda que irradia gentileza.", 55,
                "* Bebes el Té de Bondad Suprema.\n* Te sientes lleno de compasión.\n* Recuperas 55 HP y DEF +20% por 2 turnos.",
                function() { Player.heal(55); Player.addBuffDef(0.2, 2); }),
            new Item("Galleta Shooky", "Galleta con forma de un personaje molesto pero adorable.", 25,
                "* Muerdes la Galleta Shooky.\n* ¡Está crujiente! Recuperas 25 HP y VEL +15% por 2 turnos.",
                function() { Player.heal(25); Player.addBuffSpd(0.15, 2); }),
            new Item("Piruleta Kuromi", "Piruleta morada con detalles góticos y brillos.", 35,
                "* Chupas la Piruleta Kuromi.\n* Un sabor travieso y dulce.\n* Recuperas 35 HP. 20% chance de crítico el próximo turno.",
                function() { Player.heal(35); if (Player.addCritBuff) Player.addCritBuff(0.20, 1); }),
            new Item("Corazón Tata", "Un caramelo rojo con forma de corazón alienígena.", 45,
                "* Te comes el Corazón Tata.\n* Una barrera cálida te rodea.\n* Recuperas 45 HP y ganas 1 carga de escudo.",
                function() { Player.heal(45); Player.addShieldCharges(1); }),
            new Item("Bálsamo del Vacío", "Ungüento negro que absorbe la luz a su alrededor.", 70,
                "* Aplicas el Bálsamo del Vacío.\n* El vacío te protege.\n* DEF +40% por 2 turnos, pero VEL -10%.",
                function() { Player.addBuffDef(0.4, 2); Player.addBuffSpd(-0.1, 2); }),
            new Item("Cristal de Resonancia", "Un cristal vibrante que emite un zumbido armónico.", 60,
                "* Absorbes el Cristal de Resonancia.\n* Todo tu cuerpo vibra.\n* Recuperas 60 HP. ATK y DEF +10% por 2 turnos.",
                function() { Player.heal(60); Player.addBuffAtk(0.1, 2); Player.addBuffDef(0.1, 2); }),
            new Item("Elixir de Furia Estelar", "Líquido rojo ardiente embotellado en un frasco de obsidiana.", 30,
                "* Bebes el Elixir de Furia Estelar.\n* ¡ARDE! ATK +50% por 2 turnos, pero pierdes 15 HP.",
                function() { Player.addBuffAtk(0.5, 2); Player.setHP(Math.max(1, Player.getHP() - 15)); }),
            new Item("Semilla de la Vida", "Una semilla luminosa que late como un corazón.", 90,
                "* Plantas la Semilla de la Vida en tu alma.\n* Regeneras 8 HP por turno durante 4 turnos.",
                function() { if (Player.addRegen) Player.addRegen(8, 4); else Player.heal(32); }),
            new Item("Orbe Dimensional", "Una esfera translúcida que muestra otros universos.", 75,
                "* Activas el Orbe Dimensional.\n* Las dimensiones se alinean.\n* VEL +30% y ATK +15% por 3 turnos.",
                function() { Player.addBuffSpd(0.3, 3); Player.addBuffAtk(0.15, 3); })
        ];
